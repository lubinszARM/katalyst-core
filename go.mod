...
require (
	...
	github.com/kubewharf/katalyst-core v0.0.0-00010101000000-000000000000
...
replace github.com/kubewharf/katalyst-core => github.com/lubinszARM/katalyst-core v0.3.8
