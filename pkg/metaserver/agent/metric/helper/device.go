...
func GetDeviceMetricWithTime(metricsFetcher metric.MetricsFetcher, emitter metrics.MetricEmitter, metricName string, devName string) (metricutil.MetricData, error) {
...
func GetDeviceMetric(metricsFetcher metric.MetricsFetcher, emitter metrics.MetricEmitter, metricName string, devName string) (float64, error) {
