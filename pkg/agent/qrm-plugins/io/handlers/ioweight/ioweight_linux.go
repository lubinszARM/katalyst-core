...
func setIOWeightQoSLevelConfig(conf *coreconfig.Configuration,
	emitter metrics.MetricEmitter, metaServer *metaserver.MetaServer) error {
...
func IOWeightTaskFunc(conf *coreconfig.Configuration,
	...
	if len(conf.IOWeightQoSLevelConfigFile) > 0 {
		setIOWeightQoSLevelConfig(conf, emitter, metaServer)
	}
