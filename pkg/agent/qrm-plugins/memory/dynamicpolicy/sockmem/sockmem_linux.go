...
func getHostTotalMem(machineInfo *info.MachineInfo) (uint64, error) {
	...
	*/
	...
	fmt.Printf("BBLU machineInfo22 :%v...\n", machineInfo.MemoryCapacity)
	return 214748364800, nil
}

func SetHostTCPMem(tcpMemRatio uint64, machineInfo *info.MachineInfo) {
	...
	memTotal, err := getHostTotalMem(machineInfo)
	if err != nil {
