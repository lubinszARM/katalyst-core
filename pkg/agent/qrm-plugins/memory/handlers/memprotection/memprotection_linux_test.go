...
func TestGetUserSpecifiedMemoryProtectionInBytes(t *testing.T) {
	...
	result := getUserSpecifiedMemoryProtectionInBytes(1073741824.0, "10")
	var expected int64 = 107376640
	assert.Equal(t, expected, result, "Test getUserSpecifiedMemProtectionInBytes failed")

	result = getUserSpecifiedMemoryProtectionInBytes(1073741824.0, "1a")
	expected = 0
	assert.Equal(t, expected, result, "Test getUserSpecifiedMemProtectionInBytes failed")

	result = getUserSpecifiedMemoryProtectionInBytes(1073741824.0, "123")
	expected = 0
	assert.Equal(t, expected, result, "Test getUserSpecifiedMemProtectionInBytes failed")
}
