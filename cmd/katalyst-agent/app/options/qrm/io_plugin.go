...
type IOOptions struct {
	...
	WritebackThrottlingOption // option for writeback throttling, it determins the recycling speed of dirty memory.
	// TO-DO
	//DirtyThrottlingOption // option for dirty throttling, it determins the global watermark of dirty memory.
}
